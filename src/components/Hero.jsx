...
const Hero = () => {
  ...
  const images = [
    "https://images.unsplash.com/photo-1574258495973-f010dfbb5371?q=80&w=3000&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1511499767150-a48a237f0083?q=80&w=900&auto=format&fit=crop&q=60",
    ...
    <div className="relative py-16 overflow-hidden bg-gradient-to-r ">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          ...
          >
            Premium Eyewear <br className="md:hidden" /> Collection
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Discover our curated collection of designer sunglasses, eyeglasses,
            and blue-light glasses. Classic Optics - your vision, our passion.
          </motion.p>
          <motion.a
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            {images.map((image, index) => (
              <div key={index} className="relative h-80">
                ...
                <div className="absolute bottom-4 left-4 bg-gradient-to-r from-gray-900 to-gray-700 px-4 py-2 rounded-none-full shadow-lg text-sm font-medium text-white tracking-wide uppercase flex items-center gap-1">
                  <span className="text-yellow-400">★</span> Top Rated Frames
                </div>
              </div>
            ))}
          </Slider>
