  ...
  return (
    <Container>
      ...
      <ContentWrapper>
        ...
        <Paragraph>
          Welcome to Classic Optics! These terms govern your use of our website and
          services.
        </Paragraph>
        ...
        <Paragraph>
          All content on Classic Optics, including text, graphics, logos, and software,
        ...
        <List>
          <ListItem>
            Reproduce, duplicate, or copy material from Classic Optics
          </ListItem>
          <ListItem>
        ...
        <Paragraph>You agree to use Classic Optics lawfully and not to:</Paragraph>
        <List>
        ...
        <Paragraph>
          We use cookies to enhance your experience. By using Classic Optics, you
        ...
        <Paragraph>
          Classic Optics is provided "as is." We disclaim all warranties, express or
        ...
        <Paragraph>
          To the fullest extent permitted by law, Classic Optics shall not be liable
          for any indirect, incidental, or consequential damages.
        </Paragraph>

        <SectionTitle>8. Changes to Terms</SectionTitle>
        <Paragraph>
          We may revise these terms at any time. By continuing to use Classic Optics
        ...
        <ContactInfo>
          ...
          <Paragraph>
            ...
            <StyledLink href='mailto:support@classicoptics.com'>
              support@classicoptics.com <ChevronRight size={16} />
            </StyledLink>
            .
          </Paragraph>
        </ContactInfo>
